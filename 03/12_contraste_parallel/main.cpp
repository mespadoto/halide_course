...
Halide::Func get_basic_func(Halide::Buffer<uint8_t>& input, float sharpness) {
...
Halide::Func get_parallel_func(Halide::Buffer<uint8_t>& input, float sharpness) {
  Halide::Func proc, float_px;
  Halide::Var x, y, c;
...
int main(int argc, char **argv) {
  ...
  Halide::Func proc_basic = get_basic_func(input, sharpness);
  Halide::Func proc_parallel = get_parallel_func(input, sharpness);
  ...
  try {
    ...
    Halide::Tools::save_image(output_basic, "bird_sharper_basic.png");
    Halide::Tools::save_image(output_parallel, "bird_sharper_parallel.png");
  }
