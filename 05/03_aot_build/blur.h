#ifndef HALIDE__blur_h
#define HALIDE__blur_h
#include <stdint.h>
...
int my_halide_blur(struct halide_buffer_t *_input_buffer, int32_t _k_size, int32_t _k_start, int32_t _k_sq, struct halide_buffer_t *_blur_buffer);

HALIDE_FUNCTION_ATTRS
int my_halide_blur_argv(void **args);

HALIDE_FUNCTION_ATTRS
const struct halide_filter_metadata_t *my_halide_blur_metadata();
